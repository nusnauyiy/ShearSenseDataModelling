...
- video (version 2)
    ...
    - Cell 2, 4, 6, 8 represents shear in its respective direction. They are initially white, and its intensity decrease proportional to the decrease in value of raw data.
